...
<link rel="stylesheet" href="{{asset('admin/assets/vendor/fontawesome-free/css/fontawesome-all.min.css')}}">
...
{{-- <div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img src="{{asset('admin/assets/images/logo-icon.svg')}}" width="48" height="48" alt="Lucid"></div>
        <p>Please wait...</p>
    </div>
</div> --}}
...
<!-- Javascript -->
<script src="{{url('https://use.fontawesome.com/6f0d33818f.js')}}"></script>
